...
import {genPrice} from "../components/Pricing.astro";
...
<Section>
    ...
    average vtuber design with one expression toggle would be **around {genPrice(prices, true, 1, 0)}$**  
...
<Section>
    ...
    - prices listed here will probably be accurate in most cases but at the end of the day are just guidelines.
    - i may adjust the price on atypical models ie cartoon styles, body horror, etc
