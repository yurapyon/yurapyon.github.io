...
<Section>
    ...
    - i currently don't offer togglable poses for vseeface, 2d illustrations, or VRChat rigging.
        i would like to offer these though, so if it is truly a deal breaker, let me know and maybe we could work something out.
    ...
    i don't skimp. please, do not try and talk down the price.
    ...
    - super simple designs will add around 0$, while over-the-top designs could add {prices.complexity * 2}$ or more
    - its not a concrete tier system, its more just how i think about things.
    ...
    - rigging complexity doesnt have a limit, it relies on how many extra toggles you want. just let me know what you are looking for and we can go from there.
