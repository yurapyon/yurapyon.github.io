...
<Section>
    ...
    <PriceTable>
        <tr>
            <td>**simple**</td>
            <td>just shorts and a tshirt, short hair w/ basic or no physics.\
             examples: oozora subaru, pikamee</td>
        </tr>
        <tr>
            <td>**simple 2**</td>
            <td>nontogglable hoodies, kemonomimi.\
             examples: nekomata okayu, lily hopkins</td>
        </tr>
        <tr>
            <td>**average**</td>
            <td>togglable jackets or hoodies. believable shoulder length hair\
             examples: inugami korone, gwar gura</td>
        </tr>
        <tr>
            <td>**detailed**</td>
            <td>complex jackets, alot of accessories, straps, or ribbons\
             examples: fallenshadow, himemori luna</td>
        </tr>
        <tr>
            <td>**over the top**</td>
            <td>a lot of little details. tons of frills, lacey stuff, foldy fabric, crazy hair physics\
             examples: pipkin pippa, ceres fauna</td>
        </tr>
    </PriceTable>

    - simple designs will cost around 0$ for design complexity, while over-the-top designs may be {prices.complexity * 2}$ or more
    - things that add to design complexity: extra outfits, complex hair, alot of texture detail, accessories, props, kemonomimi
