...
<Section>
    ...
    <PriceTable>
        ...
        <tr>
            <td>**+???$**</td>
            <td>- complexity upcharge, starts at 0$ and goes up</td>
        </tr>
    </PriceTable>

    ---

    average vtuber design with one expression toggle would be **around {average_price}$**  
...
<Section>
    ...
    ## content
    - cute is life
    - i also like 'creepy cute'. like cute horror stuff yea
    - i have a pretty specific art style and will slightly modify the design to fit that.
    - i specialize in feminine or androgynous characters. masculine characters probably won't get accepted.
    ...
    <PriceTable>
        <tr>
            <td>**simple**</td>
            <td>- pikamee, oozora subaru (without props)</td>
        </tr>
        <tr>
            <td>**simple 2**</td>
            <td>- nekomata okayu, lily hopkins</td>
        </tr>
        <tr>
            <td>**average**</td>
            <td>- inugami korone, gwar gura, kson</td>
        </tr>
        <tr>
            <td>**detailed**</td>
            <td>- amelia watson, fallenshadow, himemori luna</td>
        </tr>
        <tr>
            <td>**over the top**</td>
            <td>- pipkin pippa, ceres fauna</td>
        </tr>
    </PriceTable>

    - simple designs will add around 0$, while over-the-top designs may add {prices.complexity * 2}$ or more
    - its not a concrete tier system this is just how i think about things.
    - things that add to design complexity: extra outfits, complex hair, frills/lacey stuff, alot of texture detail, accessories, props, kemonomimi

    ---

    - rigging complexity doesnt have a limit as it relies on how many extra toggles you want. just let me know what you are looking for and we'll go from there.
