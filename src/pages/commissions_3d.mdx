...
<Section>
    ...
    ## pricing
    i have a high standard for quality.
    above all want to make something that would look good in a portfolio, not just serve your basic needs.
    ...
    - <span class="underline">base model - {prices.base}$</span>  
        ...
        model will have: basic humanoid armature, extra bones as necessary for hair/props/expressions
    - <span class="underline">vseeface rigging - +{prices.vseeface}$</span>  
        includes .vsfavatar file. rigs will work with either webcam or iphone tracking.
        one togglable expression is included in the price.  
