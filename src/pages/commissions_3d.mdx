...
<Section>
    ...
    your average vtuber design would be **around {genPrice(prices, true, 1, 0)}$**  
...
<Section>
    ...
    - very complex rigs or designs may go beyond the {prices.tiers[2]}$ price.
...
<Section>
    <div class="bg-lmn-red">
        # 2d illustrations
    </div>

    <PriceTable>
        <tr>
            <td>**{prices.illust.base}$**</td>
            <td>- reference sheet</td>
        </tr>
        <tr>
            <td>**{prices.illust.base + prices.illust.digital}$**</td>
            <td>- digital art </td>
        </tr>
        <tr>
            <td>**{prices.illust.base + prices.illust.painted}$**</td>
            <td>- painted </td>
        </tr>
    </PriceTable>
    ...
    <span class="underline px-1.5">reference sheet - {prices.illust.base}$</span>  
    - simple reference sheet

    <div class="h-1" />

    <span class="underline px-1.5">digital art background - {prices.illust.base + prices.illust.digital}$</span>  
    - TODO: examples

    <div class="h-1" />

    <span class="underline px-1.5">painted background - {prices.illust.base + prices.illust.painted}$</span>  
    - TODO: examples
